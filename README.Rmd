...
This is due to a higher perceived danger of cyclists at night from motorised traffic and personal security, which disproportionately affect women, the elderly, and disadvantaged groups (reference needed). 
...
Previous research has found a positive association between street lighting and active travel and physical activity [@bonaccorsi_impact_2020]. 
...
df = papers %>%
  filter(behaviour == 1) %>% 
  select(authors, method, location)
