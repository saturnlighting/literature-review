...
The search strategy resulted in 281 records. Based on the examination of abstract x studies were selected. 
A flow chart of included studies is shown in Table 1.

```{r tab1, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
library(kableExtra)
tab <- matrix(c( 'Combining search and results and excluding duplicates', 'Reviewing abstracts, excluding papers out of scope of review', 'Reading full paper', 'Review of full papers', '281', 'x', 'x', 'x'), ncol = 2)
colnames(tab) <- c('Stages', 'Number of papers left')
