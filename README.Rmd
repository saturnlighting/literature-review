...
Chapter 3 critically analyses the reviewed articles and identifies gaps in the research.
...
```{r tab1, echo=FALSE}
library(kableExtra)
tab <- matrix(c( 'UK', 'UK', 'UK', 'x', 'x', 'x', 'x', 'x', 'x', '@fotios_lighting_2017', '@fotios_pilot_2017', '@uttley_road_2020'), ncol = 4)
colnames(tab) <- c('County, area or city', 'Cycling uptake measure', 'sign of association', 'Reference')
