...
In the second stage, we checked the references from the studies selected (i.e. snowball technique), and after screening abstracts and full texts, 6 additional papers were selected.
In total, 52 were reviewed.
...
<Study type>Most of the studies were written in the last decade, 35 were empirical and 9 were reviews (Figure 1).
...
Previous research has found a clear association between active travel or physical activity levels and road lighting (references needed).

"Studies in both developed world cities (DWC) and Sub-Saharan African (SSA) urban contexts point out that lack of street lighting can decrease the levels of cycling [@ribbens_impact_2008; @segadilha_identification_2014; @winters_route_2010] . @ribbens_impact_2008 indicate that cyclists avoid poorly lit streets in the townships of South Africa. @buyana_gender_2014 indicate that cyclists in the suburbs of Kampala are likely to forego a trip if the access road is not well-lit. Similarly, @winters_built_2010 in their study in Vancouver (Canada) cite that not well-lit bicycle lanes are strongly linked to the reduction of cycling rates. In addition, @chandra_street_2015 indicate that people avoid cycling in areas with cycle paths that do not have street lights at night" [@mendiate_cycling_2022].

"Studies in both SSA cities and DWC are unanimous that street lighting has an enormous influence on cycling. In line with @winters_built_2010, lack of street lighting can contribute to poor visibility, perception and fear of crime thus decreasing bicycle use. This is particularly relevant in SSA due to the generalized lack of security and safety." [@mendiate_cycling_2022].

"Positive associations were found for street lighting" [@prince_examining_2022].

"Nighttime brightness have pronounced effects on ATTS" [@luo_road_2022].
...
"Cycle tracks were valued the most, followed by street lighting and bicycle lanes" [@poorfakhraei_estimating_2015].

"Respondents reported good lighting is the most important facilitator of walking and cycling" [@lee_neighbourhood_2008].
...
The probability of suffering a traffic collision in the dark among pedestrians and cyclists is much greater than among other road users (reference needed).
Not only the frequency but also the severity of injury is higher at night-time (reference needed).

"The joint effect of heavy vehicles and diminished light conditions was associated with a 71% increased probability of sustaining KSIs" [@wiratama_joint_2022].
...
"It was observed that the factors that increase the risk of fatalities and serious injuries of bicyclists (FSI) in all clusters are: elderly bicyclist, not using a helmet, and darkness condition" [@samerei_using_2021].
...
"The safety models showed that cyclist–motorist crashes were nonlinearly associated with light pole densities" [@osama_evaluating_2017].
...
"Most nighttime fatal crashes were related to absence of street lightings" [@lu_improving_2015].
...
"Variables related to crime and lighting of public spaces were associated with AT in countries in Latin America" [@castillo-paredes_perceived_2022].

"Clean signs, balconies, cafes, street lights, no cuts between buildings, and flowers were low risk for crime and witnesses, little traffic, and bike signals low risk for crash" [@lusk_bicycle_2019]. 
...
"for pedestrians, the  deterrence of darkness was similar for males and females, which disagrees with previous studies" [@fotios_extending_2022].

<!-- "Women are more sensitive to dark spaces when walking and cycling than men" [@xie_i_2018]. -->

<Age>

Older people may detect object differently than younger people (reference needed).

<Disadvantaged groups>

"Both traffic safety concerns and personal security concerns were most strongly associated with poor neighborhood opportunities for exercise. Respondents living in lower-income communities reported greater barriers to pedestrian and bicycle safety and security than residents from wealthier neighborhoods" [@schneider_perceived_2022].
...
Papers on Smart Street Lighting (that adapts to movement by pedestrians, cyclists, and cars)(e.g. @gagliardi_advanced_2020; @abdullah_energy_2019; @juntunen_smart_2018).

"Visual function is reduced under the mesopic lighting conditions of night driving and that these effects are exacerbated by increasing age and visual impairment. Light and glare from road lighting and headlights have significant impacts on vision and night driving and these effects are likely to change with evolving technologies" [@wood_nighttime_2020].
