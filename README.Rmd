...
There is evidence that street lighting influences physical activity and active travel levels [@lee_neighbourhood_2008; @mccormack_search_2011; @cerin_neighbourhood_2017; @annear_environmental_2014; @pena-garcia_impact_2015; @yang_longitudinal_2017; @bonaccorsi_impact_2020; @prince_examining_2022].

@jin_preference_2022 found that streetlights influence pedestrians to select longer distance routes. 

@yang_crowdsourced_2022 found lighting positively associations with running but not with cycling.
...
One of the main reasons that physical activity and active travel decrease in the dark is the fear of being in a traffic crash. The pobability of suffering a traffic collision in the dark among walkers and cyclists is much greater than among other road users.
