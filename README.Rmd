...
It improves physical, mental, and social health; reduces air pollution and noise, carbon emissions, and congestion; and it is inclusive and reduces inequalities.
...
df = papers %>%
  filter(Category == "AT behaviour and lighting" | Category == "AT behaviour and lighting/AT collisions and lighting/Proper lighting" | Category == "AT behaviour and lighting/AT, crime, and lighting/Proper lighting") %>% 
  select(Authors, Year, Title, Category)
...
df = papers %>%
  filter(Category == "AT collisions and lighting" | Category == "AT collisions and lighting/Proper Lighting" | Category == "AT, crime, and lighting/AT collisions and lighting" | Category == 'AT behaviour and lighting/AT collisions and lighting/Proper lighting') %>% 
  select(Authors, Year, Title, Category)
...
df = papers %>%
  filter(Category == "AT, crime, and lighting" | Category == "AT, crime, and lighting/AT collisions and lighting" | Category == "AT, crime, and lighting/Proper lighting" | Category == 'AT behaviour and lighting/AT, crime, and lighting/Proper lighting') %>% 
  select(Authors, Year, Title, Category)
...
df = papers %>%
  filter(Category == "Inequalities in lighting") %>% 
  select(Authors, Year, Title, Category)
...
df = papers %>%
  filter(Category == "Proper lighting" | Category == "AT, crime, and lighting/Proper lighting" | Category == "AT collisions and lighting/Proper Lighting" | Category == "AT behaviour and lighting/Proper lighting" | Category == "AT behaviour and lighting/AT, crime, and lighting/Proper lighting" | Category == "AT behaviour and lighting/AT collisions and lighting/Proper lighting") %>% 
  select(Authors, Year, Title, Category)
