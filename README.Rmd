...
TBC empirical scientific studies were reviewed. 
...
2.  Is the association between road lighting and cycling uptake the same between different groups?
...
First, we searched in Elsevierś Scopus and Web of Science (WoS) (on 6 January 2023) for empirical studies investigating the relationship between cycling and road lighting. 
...
Studies that did not focus on the association between road lighting and cycling uptake were excluded. 
Many studies mentioned cycling and lighting in passing but not as the topic of the paper. Others looked at the relationship between road lighting and cycling traffic safety, but not cycling uptake.
After combining search results, excluding duplicates, and screening abstracts and full texts, TBC studies were selected.
...
Second, to make sure we didn't miss any important studies, we checked the references from the studies selected (i.e. snowball technique), and after screening abstracts and full texts of these references, TBC additional papers were selected.
...
```{r fig2, echo=FALSE, fig.cap="Figure 2: Trends and types of studies reviewed", message=FALSE, warning=FALSE, out.width='75%'}
library(kableExtra)
library(tidyverse)
