...
Many recent empirical papers have found an association between active travel or physical activity and road lighting.
Using counts of traffic flow, @fotios_effect_2022 found that darkness had a significant negative effect on the number of pedestrians and cyclists, but not on the number of motorized vehicles.
using Strava Heatmap data, @yang_crowdsourced_2022, found lighting positively associated with running but not with cycling. Differences in method and data may explain the consistency regarding cycling. 
@zacharias_environmental_2021 found road lighting significantly associated with higher uptake and deposit of dock-less shared bicycle trips.
...
@uttley_road_2020 found that the drop in cycling levels after dark was substantially greater in unlit locations, compared with lit locations.

Furthermore, previous work by @fotios_whole-year_2019 suggests that street lighting can benefit both walking and cycling.
...
@yang_longitudinal_2017
@cerin_neighbourhood_2017 @pena-garcia_impact_2015
