...
<!-- ## Search strategy -->
We used a hybrid systematic and snowballing search strategy.
...
This search strategy resulted in 1227 records.
Based on the examination of titles, abstract, and then full papers 77 studies were selected.

Second, we used a snowballing technique to include papers cited in the previous papers found. From this search we included x other papers.
...
Five main themes were identified among the reviewed papers: 1) active travel behaviour and lighting, 2) active travel collisions and lighting, 3) active travel, crime and lighting, 4) inequalities in lighting, and 5) proper lighting. Some papers focused on more than one of these themes. 
