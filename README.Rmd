...
<Aim>This paper provides a review of the scientific literature that investigates how road lighting affects cycling uptake.
...
df = papers %>%
  filter(behaviour == 1) %>% 
  select(authors, location, cycling, lighting, method, sample, association)
