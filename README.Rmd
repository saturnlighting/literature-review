...
<Visual>Figure 1 shows the number of papers reviewed by theme and year of publication.
...
ggplot(df, aes(x = year, y = number, fill = theme)) +
  geom_bar(stat="identity") +
  labs(x ="", y="number of papers") +
  theme_minimal()
```

<Study type>Most of the studies were empirical papers (53) and a few were reviews (9).
