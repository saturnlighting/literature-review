...
<Background>Many studies have explored the extent to which macro-built environmental attributes (e.g. population density, land use mix, proximity, spatial connectivity), and especially safe bicycle paths and lanes, affect cycling uptake.
...
Ten empirical scientific studies were reviewed. 
...
Road lighting has a big potential as a policy measure to encourage cycling after-dark.
...
First, we searched in Elsevierś Scopus and Web of Science (WoS) (on 9 January 2023) for empirical studies investigating the relationship between cycling and road lighting. 
...
The search resulted in 258 records in Scopus and 206 in WoS. 
...
In total, 10 studies were reviewed.
...
Research on this relationship is very recent. All the studies were written in the last fifteen years (Figure 2).
