...
"Studies in both developed world and SSA urban contexts point out that lack of street lighting can decrease the levels of cycling [41,42,44]. Ribbens et al., [41] indicate that cyclists avoid poorly lit streets in the townships of South Africa. Kareem et al., [45] indicate that cyclists in the suburbs of Kampala are likely to forego a trip if the access road is not well-lit. Similarly, Winters et al., [19] in their study in Vancouver (Canada) cite that not well-lit bicycle lanes are strongly linked to the reduction of cycling rates. In addition, Chandra and Radhakrishnan [46] indicate that people avoid cycling in areas with cycle paths that do not have street lights at night" [@mendiate_cycling_2022].

"Studies in both SSA cities and DWC are unanimous that street lighting has an enormous influence on cycling. In line with studies by UN-Habitat [59]andWinters et al., [19], lack of street lighting can contribute to poor visibility, perception and fear of crime thus decreasing bicycle use. This is particularly relevant in SSA due to the generalized lack of security and safety." [@mendiate_cycling_2022].
