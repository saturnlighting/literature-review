...
The main themes of focus, in descending order of number of papers focussed on each, were active travel collisions and lighting, followed by proper lighting for active travel and active travel behaviour and lighting.
...
There is evidence that street lighting (presence/absence, and levels) influences physical activity and active travel levels [@lee_neighbourhood_2008; @mccormack_search_2011; @prince_examining_2022; @cerin_neighbourhood_2017; @annear_environmental_2014; @pena-garcia_impact_2015; @yang_longitudinal_2017; @bonaccorsi_impact_2020].
