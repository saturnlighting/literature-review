...
There is evidence that darkness deters people from walking and cycling. It increases the risk of being involved in a collision on the road as a pedestrian or cyclist, and also increases the risk of being victim to certain crimes. This disproportionately affects different social groups.

Appropriate road lighting can increase feelings of reassurance, make hazards more visible, and make the pedestrians and cyclist more visible to other road users. However, there is to date little evidence on the lighting interventions that work best, in combination with other measures.
...
However, @fotios_lighting_2017 focus on cycling safety and on lighting for both bicycles and roads in the UK.
...
2.- To what degree darkness is associated with higher risk on road collisions among active travellers?

3.- To what extent darkness is associated with higher crime rates or fear to crime among active travellers?

4.- Is this negative association between active travel and darkness equally applicable to all groups?

Outside the scope of this review are technical engineering or smart cities papers on the most suitable type of road lighting for active travel.
<!-- Concepts to define? -->

<!-- E.g. road lighting? -->

The review is organized as follows.
Chapter 2 describes the search strategy.
