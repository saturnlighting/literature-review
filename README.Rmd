...
<*Does it make sense to write a systematic literature review on this topic? In any case, this work will help us to identify research gaps and give context to potential empirical papers (which remain the main aim).*>

# Abstract

<*Scope: Cycling or Active travel and Road Lighting? It makes more sense to focus on Active Travel (more impact, more people walk). Adapt this to active travel in general*>
