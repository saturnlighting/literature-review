...
We searched for papers from 2000 to date.
...
After screening abstracts and full text, 56 studies were selected. We excluded papers that did not focus on active travel and road lighting. The majority of excluded papers focussed on... We excluded six papers that could not be accessed.

Second, we checked the references from the studies selected (i.e. snowball technique), and after screening TBC abstracts and full texts, TBC additional papers were selected. 
